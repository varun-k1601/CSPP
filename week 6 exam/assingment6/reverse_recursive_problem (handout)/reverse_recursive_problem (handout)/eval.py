...
def run_tests(inputs, outputs, extension):
    ...
    if passed == len(inputs) and has_function and has_recursion:
        print("########## All testcases passed, code uses functions and recursion ##########")
        print("{\"_presentation\": \"semantic\"}")
        print("{\"scores\": {\"Correctness\": 10}}")
    elif passed == len(inputs) and not has_recursion:
        print("########## All testcases passed, but missing recursion ##########")
        print("{\"_presentation\": \"semantic\"}")
